...
router.post('/', asyncHandler(async(req, res, next) => {
    ...
    try {
        let queryResult = await db(`Select p.id as 'pId', ps.name as 'sort_name', p.name, p.price, p.stock, p.summary from products as p, product_sort as ps where p.sortId = ps.id`);
